...
require([
	...
	"dojo/domReady!"
], function (Map, SceneView, Polyline, Point, SimpleLineSymbol, SimpleMarkerSymbol, Graphic, GraphicsLayer) {
	map = new Map({
		basemap: "topo",
	...
	var polyline = new Polyline(eclipse.centerLine);
	...
	eclipse.timeLines.forEach(function (line) {
		...
		graphicsLayer.add(polytimeLineGraphic)
...
function weatherLoad() {
	...
	], function (Point, SimpleMarkerSymbol, Graphic, GraphicsLayer) {
